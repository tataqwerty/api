...
Name | Type | Description
--- | --- | ---
date | Строка | Date in format `YYYY-MM-DD`
responses | Число или null | Number of applications, `null` if the date is in the future or there is no data for this date
views | Число или null | Number of views, `null` if the date is in the future or there is no data for this date
