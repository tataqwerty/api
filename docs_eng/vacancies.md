...
address | object или null | [Vacancy address](address.md#Адрес)
...
code | string или null | Employer's internal vacancy code
department | object или null | Department on whose behalf the vacancy is uploaded (if available for the company). Employers can request [department directory](employer_departments.md).
department.id | string | Department ID
department.name | string | Department name
employment | object или null | Type of employment. [employment](dictionaries.md) directory entry
